                            ...
                            <div class="bg-cinza">
                                ...
                                <div class="row parceiros">
                                    <div class="col-md-3 col-sm-3">
                                        <a href={data.inst_link1} target="_blank" title={data.inst_img1} class="thumbnail">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        <a href={data.inst_link2} target="_blank" title={data.inst_img2} class="thumbnail">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        <a href={data.inst_link3} target="_blank" title={data.inst_img3} class="thumbnail">
                                    ...
                                    <div class="col-md-3 col-sm-3">
                                        <a href={data.inst_link4} target="_blank" title={data.inst_img4} class="thumbnail">
